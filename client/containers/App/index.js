    ...
    return (
      <div className="app-container">
        {this.props.sessionEnded ?
          <div className="score">
              {this.props.score > 21 ? 'You lost with ' : 'You won with ' }
              {this.props.score}!
        ...
        <div className="results">Your score: <span className="results__number">{this.props.score}</span></div>
        ...
        <div className="play-area">
          ...
          <div className="play-area__actions">
            <Button title="Add card" disable={!this.props.deckId || this.props.sessionEnded } click={() => this.props.onRequestCard()}/>
            <Button title="Stop" disable={this.props.sessionEnded || this.props.score === 0} className="is-success" click={() => this.props.onEndSession()}/>
          </div>
